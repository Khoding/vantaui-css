/* ============================================================
   BatOS docs — gallery data + renderer.
...
(function () {
  ...
  const SECTIONS = [
    /* ---------------- GETTING STARTED ---------------- */
    {
      ...
      title: 'Philosophy',
      blurb:
        'Write proper, semantic HTML — get a tactical HUD. Add <code>class="batos"</code> to a root element and bare elements (<code>button</code>, <code>article</code>, <code>input</code>, <code>table</code>, <code>meter</code>, <code>dialog</code>…) come alive with zero classes. Opt into variants with <code>data-*</code> attributes or terse <code>batos-*</code> classes. Everything ships inside <code>@layer</code>s, so your own unlayered styles always win.',
    },
    {
      group: 'Getting started',
      id: 'install',
      ...
      examples: [
        {
          ...
          code: '<!doctype html>\n<html lang="en">\n  <head>\n    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>\n    <link rel="stylesheet" href="dist/batos.min.css">\n  </head>\n  <body class="batos">\n    <h1>Command Center</h1>\n    <button type="submit">Authorize</button>\n\n    <!-- optional behaviours -->\n    <script type="module" src="js/batos.js"><\/script>\n  </body>\n</html>',
          noDemo: true,
        },
      ],
    },
    ...
    },
    {
      ...
      examples: [
        ...
        {
          code: '<p class="batos-display">DISPLAY</p>\n<p class="batos-title">TITLE ROLE</p>\n<p class="batos-heading">HEADING ROLE</p>\n<span class="batos-readout">87.4</span>\n<p class="batos-eyebrow">System eyebrow</p>\n<p class="batos-signal">CRITICAL DATA 042.7</p>',
        },
        {
          code: '<p class="batos-mono">› crypto handshake 0x4F2A…9C1B … OK</p>\n<p>Inline <code>code</code>, a <kbd>Ctrl</kbd> key, and <mark>highlighted</mark> text.</p>',
        },
      ],
    },
    {
      ...
      render: function () {
        return (
          ...
          '</div>' +
          '<div class="doc-geo">' +
          '<div class="doc-geo__plate batos-chamfer">CHAMFER</div>' +
          '<div class="doc-geo__plate batos-notch">NOTCH</div>' +
    ...
    },
    {
      ...
      examples: [
        {
          code: '<div class="batos-row">\n  <span class="batos-dot"></span>\n  <span class="batos-dot batos-dot--warn"></span>\n  <span class="batos-dot batos-dot--threat"></span>\n  <span class="batos-dot batos-dot--cyan"></span>\n  <span class="batos-dot batos-dot--idle"></span>\n</div>',
        },
        {
          code: '<div class="batos-cluster">\n  <span class="batos-badge batos-glow-cyan">glow-cyan</span>\n  <span class="batos-badge batos-badge--amber batos-glow-amber">glow-amber</span>\n  <span class="batos-badge batos-badge--red batos-glow-red">glow-red</span>\n</div>',
        },
      ],
    },
    ...
    /* ---------------- LAYOUT ---------------- */
    {
      ...
      blurb:
        'Mobile-first like BeerCSS: children stack on the smallest screen, then opt into spans with batos-s* / batos-m* / batos-l*.',
      examples: [
        {
          code: '<div class="batos-grid">\n  <article class="batos-s12 batos-m6 batos-l4">A</article>\n  <article class="batos-s12 batos-m6 batos-l4">B</article>\n  <article class="batos-s12 batos-m12 batos-l4">C</article>\n</div>',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      examples: [
        {
          code: '<article data-brackets>\n  <header>\n    <span class="batos-panel__eyebrow">Case File</span>\n    <span class="batos-panel__aside">14-C</span>\n  </header>\n  <p>Recovered intel from the broker drop. Chain of custody verified.</p>\n  <footer><button data-size="sm">Open</button></footer>\n</article>',
        },
        {
          code: '<div class="batos-grid">\n  <div class="batos-panel batos-panel--inset batos-s12 batos-m6">Inset well</div>\n  <div class="batos-panel batos-panel--glow batos-s12 batos-m6">Accent glow</div>\n</div>',
        },
      ],
    },
    {
      ...
      examples: [
        {
          code: '<div class="batos-cluster">\n  <span class="batos-badge batos-badge--green batos-badge--dot">Online</span>\n  <span class="batos-badge batos-badge--cyan">Encrypted</span>\n  <span class="batos-badge batos-badge--amber batos-badge--solid">Caution</span>\n  <span class="batos-badge batos-badge--red batos-badge--dot">Threat</span>\n  <span class="batos-badge batos-badge--neutral">Idle</span>\n</div>',
        },
      ],
    },
    {
      ...
      examples: [
        ...
        {
          code: '<label>\n  <span class="batos-field__label">Frequency</span>\n  <input type="range" min="0" max="100" value="62">\n</label>\n<label>\n  <span class="batos-field__label">Notes</span>\n  <textarea placeholder="Field report…"></textarea>\n</label>',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      blurb:
        'Native <code>&lt;meter&gt;</code> and <code>&lt;progress&gt;</code> become telemetry bars. The <code>.batos-meter</code> composite adds a label + auto value readout, driven purely by <code>--value</code>. Add <code>data-animate</code> (with the JS helper) to count up on view.',
      examples: [
        {
          code: '<meter min="0" max="100" low="30" high="70" optimum="100" value="86"></meter>\n<progress max="100" value="62"></progress>',
        },
        {
          code: '<div class="batos-meter batos-meter--segmented" style="--value:73">\n  <div class="batos-meter__top">\n    <span class="batos-meter__label">Suit Integrity</span>\n    <span class="batos-meter__val"></span>\n  </div>\n  <div class="batos-meter__track"><div class="batos-meter__fill"></div></div>\n</div>',
        },
        {
          code: '<div class="batos-meter batos-meter--amber" data-value="62" data-animate style="--value:0">\n  <div class="batos-meter__top">\n    <span class="batos-meter__label">Threat Level</span>\n    <span class="batos-meter__val"></span>\n  </div>\n  <div class="batos-meter__track"><div class="batos-meter__fill"></div></div>\n</div>',
        },
      ],
    },
    {
      ...
      examples: [
        {
          code: '<div class="batos-cluster">\n  <div class="batos-gauge" style="--value:87">\n    <b class="batos-gauge__value"></b><small>%</small>\n    <span class="batos-gauge__label">Integrity</span>\n  </div>\n  <div class="batos-gauge batos-gauge--amber batos-gauge--sm" style="--value:42">\n    <b class="batos-gauge__value"></b><small>%</small>\n    <span class="batos-gauge__label">Threat</span>\n  </div>\n</div>',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      examples: [
        {
          code: '<button onclick="this.nextElementSibling.showModal()">Open dialog</button>\n<dialog>\n  <header>\n    <span class="batos-panel__eyebrow">Confirm</span>\n    <button class="batos-btn--icon" onclick="this.closest(\'dialog\').close()"><i class="ti ti-x"></i></button>\n  </header>\n  <div class="batos-dialog__body">Engage the Knightfall protocol?</div>\n  <footer>\n    <button class="batos-btn--ghost" onclick="this.closest(\'dialog\').close()">Cancel</button>\n    <button type="submit" data-tone="danger" onclick="this.closest(\'dialog\').close()">Engage</button>\n  </footer>\n</dialog>',
        },
        {
          code: '<span class="batos-tooltip" data-tip="Decryption in progress" tabindex="0">\n  <button class="batos-btn--icon"><i class="ti ti-lock"></i></button>\n</span>\n<div class="batos-divider" data-label="Sector 14-C" style="margin-block:16px"></div>\n<div class="batos-kv"><span>Operator</span><span>B. Wayne</span></div>\n<div class="batos-stat batos-stat--signal"><b>98.6</b><span>Integrity</span></div>',
        },
      ],
    },
    ...
    /* ---------------- PATTERNS ---------------- */
    {
      ...
      examples: [
        {
          frame: true,
          code: '<div class="batos-app">\n  <nav class="batos-rail">\n    <div class="batos-rail__emblem"><img src="../assets/emblem.svg" alt="BatOS"></div>\n    <button class="batos-rail__item batos-rail__item--active"><i class="ti ti-layout-dashboard"></i></button>\n    <button class="batos-rail__item"><i class="ti ti-files"></i></button>\n    <button class="batos-rail__item"><i class="ti ti-tools"></i></button>\n    <div class="batos-rail__spacer"></div>\n    <button class="batos-rail__item"><i class="ti ti-settings"></i></button>\n  </nav>\n  <header class="batos-topbar">\n    <span class="batos-topbar__eyebrow"><b>//</b> WayneTech OS</span>\n    <div class="batos-topbar__spacer"></div>\n    <span class="batos-topbar__stat"><span class="batos-dot"></span> Online</span>\n    <span class="batos-topbar__user">BW</span>\n  </header>\n  <main class="batos-stage">\n    <div class="batos-stage__inner">\n      <div class="batos-screen-head">\n        <div>\n          <h1 class="batos-screen-title">Command Center</h1>\n          <p class="batos-screen-sub">Operational overview · night cycle 02:14</p>\n        </div>\n        <button data-tone="amber">Knightfall</button>\n      </div>\n      <div class="batos-grid">\n        <article class="batos-s12 batos-m4"><div class="batos-stat batos-stat--signal"><b>07</b><span>Active cases</span></div></article>\n        <article class="batos-s12 batos-m4"><div class="batos-stat batos-stat--amber"><b>12</b><span>Hostiles</span></div></article>\n        <article class="batos-s12 batos-m4"><div class="batos-stat"><b>04:18</b><span>Elapsed</span></div></article>\n      </div>\n    </div>\n  </main>\n</div>',
        },
      ],
    },
    {
      ...
      blurb:
        'Optional and zero-dependency. <code>BatOS.init()</code> runs on load; call it again after injecting markup. <code>BatOS.setValue(el, n)</code> animates a meter/gauge; <code>[data-batos-clock]</code> ticks live.',
      examples: [
        {
          noDemo: true,
          code: 'import BatOS from "./js/batos.js";\n\n// re-scan after you inject DOM (frameworks, htmx, etc.)\nBatOS.init(document);\n\n// animate a meter or gauge to a value\nBatOS.setValue(document.querySelector(".batos-gauge"), 87);\n\n// live clock — any element:\n// <span data-batos-clock>00:00:00</span>',
        },
      ],
    },
    {
      ...
      title: 'Vue & Nuxt',
      blurb:
        'Framework-agnostic by design, with first-class adapters. The Vue plugin adds <code>class="batos"</code> to the root and runs the helpers; the Nuxt module wires the CSS + client plugin for you.',
      examples: [
        {
          noDemo: true,
  ...
  function boot() {
    ...
    wireCopy();
    wireSpy();
    if (window.BatOS && window.BatOS.init) window.BatOS.init(document);
  }
