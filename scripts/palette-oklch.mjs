...
const alphas = [
  ['cyan-glow', 66, 227, 255, 0.55],
  ['amber-glow', 255, 138, 26, 0.5],
  ['red-glow', 255, 46, 63, 0.5],
  ['green-glow', 33, 217, 126, 0.45],
  ['hairline', 120, 196, 240, 0.16],
  ['hairline-strong', 120, 196, 240, 0.32],
  ['hairline-accent', 66, 227, 255, 0.45],
  ['scrim', 2, 6, 11, 0.72],
];
